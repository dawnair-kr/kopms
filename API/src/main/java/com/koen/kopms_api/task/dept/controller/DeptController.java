package com.koen.kopms_api.task.dept.controller;
...
//    	log.info("DeptController - getDepts for searchMap : {}", searchMap);
    	
    	HashMap<String, Object> resultMap = deptService.getDepts(searchMap);
    ...
    /**
     * 부서 메뉴 권한 조회
     * POST /dept/getDeptMenus
     */
    @PostMapping("/getDeptMenus")
    public CommonResponse<?> getDeptMenus(HttpServletRequest request, @RequestBody HashMap<String, Object> searchMap) throws Exception {
    	HashMap<String, Object> resultMap = deptService.getDeptMenus(searchMap);
    	return new CommonResponse<HashMap<String, Object>>(0, messageUtil.getMessage(ExceptionMsg.SUCC_QUERY), resultMap);
    }
