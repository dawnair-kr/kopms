    ...
    <v-form ref="formManager">
      <v-sheet rounded="lg" class="pa-4 mb-3 form-card">
        ...
        <div class="field-item mb-4">
          ...
          <v-textarea
            v-model="model.bizInfo.riskManagerSummary"
            variant="outlined"
            density="compact"
            rows="3"
            no-resize
    ...
    <v-form ref="formResult">
      <v-sheet rounded="lg" class="pa-4 mb-3 form-card">
        ...
        <div class="field-item mb-4">
          <span class="field-label required">요약정보</span>
          <v-textarea
            v-model="model.bizInfo.managerResultSummary"
            variant="outlined"
            density="compact"
            rows="3"
            no-resize
        ...
        <!-- 평가결과 -->
        <div class="field-item mb-4">
          <span class="field-label required">평가결과</span>
          <v-textarea
            v-model="model.bizInfo.managerAppResult"
            variant="outlined"
            density="compact"
            rows="3"
            no-resize
...
const MANAGER_FIELDS = [
  'riskManagerSummary', 'riskManagerMethod', 'riskManagerContents',
  'riskManagerRegiDate', 'riskManagerUpdateDate', 'riskManagerFinishDate', 'riskManagerState',
  'attachFileSeq1', 'mikepState1', 'approvalLink1',
];
const RESULT_FIELDS = [
  'managerResultSummary', 'managerAppResult', 'attachFileSeq2',
  'managerRegiDate', 'managerUpdateDate', 'approvalRegiDate', 'approvalFinishDate',
  'managerState', 'approvalLink', 'meetingTime', 'meetingPlace',
  'mikepState', 'resultRegiDate', 'resultFinishDate',
  'mikepState2', 'approvalLink2', 'checkMethod',
];
const ALL_FIELDS = [...MANAGER_FIELDS, ...RESULT_FIELDS];

const saveSection = (section, overrides = {}) => {
  const fieldMap = { riskManager: MANAGER_FIELDS, result: RESULT_FIELDS };
...
// [9] 생명주기
// ============================================================
useBizBreadcrumb('입찰참여결정 - 리스크관리위원회');
</script>
