      ...
      <v-row no-gutters class="mb-4">
        <v-col>
          <div class="field-item">
            ...
            <v-textarea
              v-model="modelValue.bizInfo.selectContents"
              variant="outlined"
              density="compact"
              rows="3"
              no-resize
      ...
      <v-row no-gutters class="mb-4">
        <v-col>
          <div class="field-item">
            ...
            <v-btn-toggle
              v-model="modelValue.bizInfo.checkMethod"
              mandatory
              density="compact"
              :disabled="isCompleted"
              class="toggle-group"
            >
              ...
              <v-btn value="N" variant="text" class="toggle-btn toggle-btn-danger">부적합</v-btn>
            </v-btn-toggle>
          </div>
        </v-col>
      </v-row>
