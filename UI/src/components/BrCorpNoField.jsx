...
import { corpNoFormatter, setCursor } from '../util/fmt';
...
export const makeBrCorpNoFieldProps = propsFactory({
  autofocus: Boolean,
...
export default genericComponent()({
  ...
  setup (props, { attrs, emit, slots }) {
    ...
    const _inputValue = ref(corpNoFormatter(model.value, true, true));
    ...
    const inputValue = computed({
      ...
      set: (val) => {        
        if ( val && val.length ) {
          ...
          _inputValue.value = corpNoFormatter(val, true, true);
    ...
    function onInput (e) {
      ...
      let fmtValue = corpNoFormatter(el.value, true, true);
