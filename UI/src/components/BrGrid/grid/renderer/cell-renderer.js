    ...
    CellRenderer.prototype.evaluate = function (node, cell, data, attributes, fData, isEdit) {
        ...
        if (cell.column.template) {
            ...
            if (isReactCompiler || isReactChild) {
                ...
                // add by hspark
                dummyData = extendObjWithFn(data, (_a = {}, _a[foreignKeyData] = fData, _a.column = cell.column, _a));
                //dummyData.index = attributes[literals_1[0]];
                result = cell.column.getColumnTemplate()(extend(dummyData, { 'index': attributes[literals_1[0]] }), this.parent, 'template', templateID, this.parent["" + str], undefined, undefined, this.parent['root']);
            }
            if (!isReactCompiler && !isReactChild) {
