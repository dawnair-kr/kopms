...
var Render = /** @class */ (function () {
    ...
    Render.prototype.refreshUI = function (args, address, initLoad, isRefreshing, preventModelCheck, openOptions) {
        /*
        console.log("render refreshUI", "args", args, "address", address, "initLoad", initLoad, 
            "isRefreshing", isRefreshing, "preventModelCheck", preventModelCheck, "openOptions", openOptions)
        */
        var _this = this;
        if (args.refresh !== 'All') {
            this.parent.showSpinner();
