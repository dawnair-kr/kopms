...
export declare class Snapping {
     ...
     * @private
     */
    snapPoint(diagram: Diagram, selectedObject: SelectorModel, towardsLeft: boolean, towardsTop: boolean, delta: PointModel, startPoint: PointModel, endPoint: PointModel, dragWrapper?: Container): PointModel;
    /**
     * @private
     */
