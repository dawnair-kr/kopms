...
var BpmnDiagrams = /** @class */ (function () {
    ...
    BpmnDiagrams.prototype.getBPMNTextAnnotation = function (node, diagram, annotation, content) {
        ...
        annotationContainer.isTextAnnotation = true;
    ...
    BpmnDiagrams.prototype.removeAnnotationObjects = function (parentNode, annotation, diagram) {
        ...
        if (index !== -1) {
            ...
            if (entry && entry[annotation.id]) {
                ...
                var nodeIndex = nodeContent.children.indexOf(annotationNode.wrapper);
                nodeContent.children.splice(nodeIndex, 1);
                var conIndex = nodeContent.children.indexOf(annotationConnector.wrapper);
                nodeContent.children.splice(conIndex, 1);
                ...
                var edgeIndex = parentNode.outEdges.indexOf(annotationConnector.id);
                if (edgeIndex !== -1) {
                    parentNode.outEdges.splice(edgeIndex, 1);
                }
