...
var Snapping = /** @class */ (function () {
     ...
     * @private
     */
    Snapping.prototype.snapPoint = function (diagram, selectedObject, towardsLeft, towardsTop, delta, startPoint, endPoint, dragWrapper) {
        var snapSettings = this.diagram.snapSettings;
        var zoomFactor = this.diagram.scroller.currentZoom;
        var offset = { x: 0, y: 0 };
        var wrapper = dragWrapper ? dragWrapper : this.getWrapperObject(selectedObject, diagram.nameTable);
