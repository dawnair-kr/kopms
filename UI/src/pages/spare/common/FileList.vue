  ...
  <div>
    <v-row no-gutters align="center" justify="center" class="pageperrows file-list">
      <v-col align="left" class="px-0" style="overflow-x: auto">
        <v-data-table class="border" :headers="getFileHeaders()" :items="files" :page="currentPage" item-value="name" :loading="loading" color="#ff0000" :items-per-page="pagePerRow" hide-actions>
          ...
          <template v-slot:bottom>
            ...
            <v-row no-gutters align="center" justify="center" class="mx-1 mt-0">
              ...
              <v-col align="center" class="pa-2">
                <v-pagination v-model="currentPage" :length="getPageCount" rounded="circle" :total-visible="7" show-first-last-page size="small" first-icon="mdi-page-first" prev-icon="mdi-menu-left"
    ...
    <v-row v-if="enableUpload" no-gutters class="file-list" align="center" justify="center">
      <v-col align="center" class="px-2 pt-1 pb-2">
        <v-sheet border="lg dotted" class="pa-2" rounded="md" max-width="300" min-width="150" height="100" ref="dropzone">
