<template>
  <!-- <v-card flat border rounded="md" class="pa-2" width="100%"> -->
    <v-row no-gutters align="center" justify="center" class="pageperrows file-list pa-2">
      <v-col align="left" class="px-0" style="overflow-x: auto">
        <v-data-table class="border" :headers="getFileHeaders()" :items="files" :page="currentPage"
          item-value="name" :loading="loading" color="#ff0000" :items-per-page="pagePerRow" hide-actions hover>
          ...
          <template v-slot:item.jobs="{ item }">
            <v-btn variant="text" color="grey-darken-2" density="comfortable" icon="mdi-delete-forever"
